...
GO
PRINT N'Creating [configuration]...';
...
GO
PRINT N'Creating [configuration].[Settings]...';
...
CREATE TABLE [configuration].[Settings] (
    ...
    CONSTRAINT [PK_Settings] PRIMARY KEY CLUSTERED ([Id] ASC) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY];


GO
PRINT N'Creating [configuration].[TenantSecurity]...';
...
CREATE TABLE [configuration].[TenantSecurity] (
    ...
    [active]           BIT              NOT NULL,
    CONSTRAINT [PK_TenantSecurity] PRIMARY KEY CLUSTERED ([TenantSecurityId] ASC) ON [PRIMARY]
) ON [PRIMARY];


GO
PRINT N'Creating [configuration].[Tenant]...';
...
CREATE TABLE [configuration].[Tenant] (
    ...
    [Active]           BIT            NOT NULL,
    CONSTRAINT [PK_Tenant] PRIMARY KEY CLUSTERED ([TenantId] ASC) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY];
...
GO
PRINT N'Creating [configuration].[DF_configuration.Tenant_Active]...';


GO
ALTER TABLE [configuration].[Tenant]
    ADD CONSTRAINT [DF_configuration.Tenant_Active] DEFAULT ((1)) FOR [Active];


GO
PRINT N'Creating unnamed constraint on [dbo].[Xpath]...';


GO
ALTER TABLE [dbo].[Xpath]
    ADD DEFAULT 0 FOR [Type];


GO
PRINT N'Creating [configuration].[FK_Settings_Tenant]...';


GO
ALTER TABLE [configuration].[Settings]
    ADD CONSTRAINT [FK_Settings_Tenant] FOREIGN KEY ([TenantId]) REFERENCES [configuration].[Tenant] ([TenantId]);


GO
PRINT N'Creating [configuration].[FK_TenantSecurity_Tenant]...';


GO
ALTER TABLE [configuration].[TenantSecurity]
    ADD CONSTRAINT [FK_TenantSecurity_Tenant] FOREIGN KEY ([TenantId]) REFERENCES [configuration].[Tenant] ([TenantId]);
...
END
GO
PRINT N'Creating [dbo].[stp_selectLog]...';
