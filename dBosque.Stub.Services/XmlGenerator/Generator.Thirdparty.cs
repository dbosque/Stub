namespace Microsoft.Xml.XMLGen {
    ...
    internal abstract class XmlValueGenerator {
        ...
        internal virtual void AddGenerator(XmlValueGenerator genr) {
            return;
        }

        internal abstract string GenerateValue();
        ...
        internal override string GenerateValue() {
                return value;
            }
        }
        ...
        internal object GetEnumerationValue() {
        ...
        internal void ProcessLengthFacet(ref StringBuilder genString, int index) {
        ...
        internal void ProcessMinLengthFacet(ref StringBuilder genString, int index) {
                int pLength = genString.Length;
                int indexLen = index.ToString().Length;
        ...
        internal void ProcessMaxLengthFacet(ref StringBuilder genString, int index) {
                int pLength = genString.Length;
                int indexLen = index.ToString().Length;
        ...
        internal Generator_string(CompiledFacets rFacets) {
                if(rFacets != null) {
                    CheckFacets(rFacets);
                }
            }
        ...
        internal Generator_decimal(CompiledFacets rFacets) {
                CheckFacets(rFacets);
            }
        ...
        internal Generator_integer(CompiledFacets rFacets) : base(rFacets) {
        ...
        internal Generator_nonPositiveInteger(CompiledFacets rFacets) {
                startValue = 0;
                increment = 1;
                maxBound = 0;
                CheckFacets(rFacets);
        ...
        internal Generator_negativeInteger(CompiledFacets rFacets) {
                startValue = -1;
                maxBound = -1;
                CheckFacets(rFacets);
            }
        ...
        internal Generator_long(CompiledFacets rFacets) {
                maxBound = 9223372036854775807;
                minBound = -9223372036854775807;
                CheckFacets(rFacets);
            }
        ...
        internal Generator_int() {
                maxBound = 2147483647;
                minBound = -2147483647;
            }

        internal Generator_int(CompiledFacets rFacets) {
                maxBound = 2147483647;
                minBound = -2147483647;
                CheckFacets(rFacets);
            }
        ...
        internal Generator_short(CompiledFacets rFacets) {
                maxBound = 32767;
                minBound = -32768;
                CheckFacets(rFacets);
            }
        ...
        internal Generator_byte(CompiledFacets rFacets) {
                maxBound = 127;
                minBound = -128;
                CheckFacets(rFacets);
            }
        ...
        internal Generator_nonNegativeInteger(CompiledFacets rFacets) {
                startValue = 0;
                minBound = 0;
                CheckFacets(rFacets);
            }
        ...
        internal Generator_unsignedLong(CompiledFacets rFacets) {
        ...
        internal Generator_unsignedInt(CompiledFacets rFacets) {
                maxBound = 4294967295;
                CheckFacets(rFacets);
            }
        }
        ...
        internal Generator_unsignedShort(CompiledFacets rFacets) {
                maxBound = 65535;
                CheckFacets(rFacets);
            }
        }
        ...
        internal Generator_unsignedByte(CompiledFacets rFacets) {
                maxBound = 255;
                CheckFacets(rFacets);
            }
        }
        ...
        internal Generator_positiveInteger(CompiledFacets rFacets) {
                startValue = 1;
                minBound = 1;
                CheckFacets(rFacets);
            }
        ...
        internal Generator_double(CompiledFacets rFacets) {
                 CheckFacets(rFacets);
            }
        ...
        internal Generator_float(CompiledFacets rFacets) {
                CheckFacets(rFacets);
            }
            internal void CheckFacets(CompiledFacets genFacets) {
                if(genFacets != null) {
        ...
        internal class Generator_duration : XmlValueGenerator {
            ...
            int stateStep = 1;
            internal Generator_duration(CompiledFacets rFacets) {
                CheckFacets(rFacets);
            }
      ...
      internal class Generator_dateTime : XmlValueGenerator {
            ...
            internal Generator_dateTime (CompiledFacets rFacets) {
                CheckFacets(rFacets);
            }
      ...
      internal class Generator_gYearMonth : Generator_dateTime {
            internal Generator_gYearMonth(CompiledFacets rFacets) {
      ...
      internal class Generator_gYear : Generator_dateTime {
            internal Generator_gYear(CompiledFacets rFacets) {
      ...
      internal class Generator_gMonthDay : Generator_dateTime {
            internal Generator_gMonthDay(CompiledFacets rFacets) {
      ...
      internal class Generator_gMonth : Generator_dateTime {
            internal Generator_gMonth(CompiledFacets rFacets) {
                step = XmlConvert.ToTimeSpan("P32D");
                CheckFacets(rFacets);
            }
      ...
      internal class Generator_time : Generator_dateTime {
            internal Generator_time(CompiledFacets rFacets) {
      ...
      internal class Generator_hexBinary : Generator_facetBase {
          ...
          internal Generator_hexBinary(CompiledFacets rFacets) {
      ...
      internal class Generator_base64Binary : Generator_facetBase {
          ...
          internal Generator_base64Binary(CompiledFacets rFacets) {
                CheckFacets(rFacets);
          }
      ...
      internal class Generator_QName : Generator_string {
          ...
          internal Generator_QName(CompiledFacets rFacets) {
                Prefix = "qname";
                CheckFacets(rFacets);
          }
      ...
      internal class Generator_Notation : Generator_QName {
          ...
          internal Generator_Notation(CompiledFacets rFacets) {
             CheckFacets(rFacets);
          }
      }
    
      internal class Generator_normalizedString : Generator_string {
          internal Generator_normalizedString() {
          }
          internal Generator_normalizedString(CompiledFacets rFacets) : base(rFacets){
          }
      }
      ...
      internal class Generator_token : Generator_normalizedString {
          ...
          internal Generator_token(CompiledFacets rFacets) {
              Prefix = "Token";
              CheckFacets(rFacets);
          }
      }
      ...
      internal class Generator_NMTOKEN : Generator_token {
          ...
          internal Generator_NMTOKEN() {
          }
            
          internal Generator_NMTOKEN(CompiledFacets rFacets) : base(rFacets){
          }
      }

      internal class Generator_Name : Generator_string {

          internal Generator_Name(CompiledFacets rFacets){
              Prefix = "Name";
              CheckFacets(rFacets);
          }
      }
      ...
      internal class Generator_NCName : Generator_string {
          ...
          internal Generator_NCName(CompiledFacets rFacets) {
              Prefix = "NcName";
              CheckFacets(rFacets);
          }
      }
      ...
      internal class Generator_IDREF : Generator_string {
        ...
        internal class Generator_anyURI : Generator_string {
            internal Generator_anyURI(CompiledFacets rFacets) {
                Prefix = "http://uri";
                CheckFacets(rFacets);
            }
        }
        ...
        internal class Generator_Union : Generator_facetBase {
           ...
           internal Generator_Union(CompiledFacets rFacets) {
               CheckFacets(rFacets);
           }

           internal override void AddGenerator(XmlValueGenerator genr) {
                unionGens.Add(genr);
           }
        ...
        internal class Generator_List : Generator_facetBase {
           ...
           internal Generator_List(CompiledFacets rFacets) {
               CheckFacets(rFacets);
           }
           ...
           internal override void AddGenerator(XmlValueGenerator valueGenr) {
                genr = valueGenr;
           }
