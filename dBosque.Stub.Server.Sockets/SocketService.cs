...
using dBosque.Stub.Server.Sockets.Models;
using dBosque.Stub.Server.Sockets.Types;
...
namespace dBosque.Stub.Server.Sockets
{
...
#pragma warning restore S3881 // "IDisposable" should be implemented correctly
    {
        ...
        public SocketService(IStubHandler<string> handler, IConfigurationRepository config, IOptions<Configuration.Hosting> hosting, ILogger<SocketService> logger)
        {
            _handler = handler;
            _logger = logger;
