...
namespace dBosque.Stub.Server.WebApi.Configuration.Raw
{
    /// <summary>
    ...
    public class RawRequestBodyFormatter : InputFormatter
    {
        ...
        public RawRequestBodyFormatter()
        {
            ...
            SupportedMediaTypes.Add(new MediaTypeHeaderValue(ContentTypes.ApplicationJson));
            SupportedMediaTypes.Add(new MediaTypeHeaderValue(ContentTypes.TextPlain));
            SupportedMediaTypes.Add(new MediaTypeHeaderValue(ContentTypes.ApplicationOctetStream));
        }
        ...
        public override async Task<InputFormatterResult> ReadRequestBodyAsync(InputFormatterContext context)
        {
            ...
            if (contentType == ContentTypes.ApplicationOctetStream)
            {
